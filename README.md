...
- `easy/` вЂ“ beginner-level problems  
- `medium/` вЂ“ intermediate challenges  
- `hard/` вЂ“ advanced questions  
- `utils/` вЂ“ code templates or reusable snippets

---

## рџ§ѕ File Naming Format
